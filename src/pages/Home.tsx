...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex flex-col md:flex-row gap-16 mb-9">
                ...
                <img
                  ...
                  onClick={() =>
                    openLightbox(
                      ...
                      "W poszukiwaniu III materii, cz. I",
                    )
                  }
                />
              ...
              <div className="flex-1 flex flex-col gap-6">
                <img
                  ...
                  onClick={() =>
                    openLightbox(
                      "/artworks/collections/iii-materia/materia-02.jpg",
                      "W poszukiwaniu III materii, cz. II",
                    )
                  }
                />
              ...
              <img
                ...
                onClick={() =>
                  openLightbox(
                    ...
                    "W poszukiwaniu III materii, cz. III",
                  )
                }
              />
              ...
              <div className="flex flex-col gap-3">
                <div className="flex">
                  <Link
                    ...
                    className="text-2xl font-medium leading-[110%] tracking-[-0.04em] uppercase text-secondary-foreground hover:text-white transition-colors opacity-50 hover:opacity-100"
                  >
                    GRAFIKI
                  </Link>
                </div>
            ...
            <div className="flex flex-col md:flex-row px-0 items-start gap-[42px] self-stretch">
                ...
                <img
                  ...
                  onClick={() =>
                    openLightbox(
                      ...
                      "W poszukiwaniu III materii, cz. V",
                    )
                  }
                />
              ...
              <div className="flex flex-col justify-center items-start gap-6 flex-1">
                <img
                  ...
                  onClick={() =>
                    openLightbox(
                      "/artworks/collections/iii-materia/materia-06.jpg",
                      "W poszukiwaniu III materii, cz. VI",
                    )
                  }
                />
              ...
              <img
                ...
                onClick={() =>
                  openLightbox(
                    ...
                    "W poszukiwaniu III materii, cz. VII",
                  )
                }
              />
            </div>
          ...
          <section className="max-w-[1648px] mx-auto px-0 py-[100px] flex flex-col items-start gap-9">
            ...
            <div className="flex px-9 flex-col justify-center items-center gap-16 self-stretch">
              <img
                ...
                onClick={() =>
                  openLightbox(
                    "/artworks/collections/iii-materia/materia-08.jpg",
                    "W poszukiwaniu III materii, cz. VIII",
                  )
                }
              />
            </div>
            ...
            <div className="px-9 items-start gap-[42px] self-stretch flex flex-col md:flex-row">
                ...
                <img
                  ...
                  onClick={() =>
                    openLightbox(
                      ...
                      "W poszukiwaniu III materii, cz. IX",
                    )
                  }
                />
              ...
              <div className="flex flex-col items-start gap-6 flex-1">
                <img
                  ...
                  onClick={() =>
                    openLightbox(
                      "/artworks/collections/iii-materia/materia-10.jpg",
                      "W poszukiwaniu III materii, cz. X",
                    )
                  }
                />
      ...
      {/* Lightbox */}
      {lightboxImage && (
        <ImageLightbox image={lightboxImage.src} title={lightboxImage.title} onClose={() => setLightboxImage(null)} />
      )}
    </div>
  );
};
